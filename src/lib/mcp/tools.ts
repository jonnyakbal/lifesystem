...
export function registerAllTools(server: McpServer, scopes: string[] = ['*']) {
  ...
  registerCrudTools(server, {
    ...
    createShape: {
      ...
      status: z.string().optional().describe('Padrão: todo. IDs de etapa configuráveis — use list_tasks pra ver as etapas existentes.'),
  ...
  registerCrudTools(server, {
    ...
    createShape: {
      ...
      description: z.string().optional(),
      status: z.string().optional().describe('Padrão: idea. IDs de etapa configuráveis — use list_projects pra ver as etapas existentes.'),
      tags: z.array(z.string()).optional(),
  ...
  registerCrudTools(server, {
    ...
    collection: 'editais',
    plural: 'editais',
    listFilters: ['stage', 'pillarId'],
    createShape: {
      title: z.string().describe('Título do edital'),
      orgao: z.string().optional().describe('Órgão/instituição responsável'),
      description: z.string().optional(),
      valor: z.number().optional().describe('Valor do edital em reais'),
      prazoInscricao: z.string().optional().describe('Formato YYYY-MM-DD'),
      link: z.string().optional(),
      pillarId: z.string().optional(),
      stage: z.string().optional().describe('Padrão: radar. Etapas configuráveis — use list_editais pra ver as existentes.'),
    ...
    updateShape: {
      ...
      prazoInscricao: z.string().optional(),
      link: z.string().optional(),
      pillarId: z.string().optional(),
    ...
    buildCreatePayload: (input) => ({
      ...
      description: input.description,
      valor: input.valor,
      prazoInscricao: input.prazoInscricao,
      link: input.link,
      pillarId: input.pillarId,
